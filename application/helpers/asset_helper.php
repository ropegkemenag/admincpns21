...
if ( ! function_exists('template'))
{
    ...
    {
        $CI =& get_instance();
        return $CI->config->item('site_template');
    }
}
/**
 * Get Admin URL
...
{
    function admin_url($param=null)
    {
        $CI =& get_instance();
        return base_url() . $CI->config->item('admin_path') . $param;
    }
}
...
{
    function client_url($param=null)
    {
        $CI =& get_instance();
        return base_url() . 'admin/' . $param;
    }
}
